 ...
 */
package com.homegrown.tools.code.generator.struct.processor.demo.utils.compile;
...
public class Compile {
    ...
    public static Class<?> compile(File sourceFile, String className, CompileOptions compileOptions) {
        try {
            return compile(className,readAllLines(sourceFile.toPath()),compileOptions);
        } catch (IOException e) {
            e.printStackTrace();
        }
        return null;
